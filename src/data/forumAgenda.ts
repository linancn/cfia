...
export const masterAgendaSlots: MasterAgendaSlot[] = [
  ...
  },
  {
    ...
    shortTitle: {
      zh: "碳足迹因子库建设专题研讨会",
      en: "Carbon Footprint Factor Database Workshop",
    },
    status: "pending",
  },
  {
    ...
    shortTitle: { zh: "LCA 开发者大会", en: "LCA Developer Forum" },
    status: "updating",
  },
  {
    ...
    shortTitle: { zh: "联盟年度大会", en: "Alliance Annual Meeting" },
    status: "published",
  },
  {
    id: "d1-special-power-pm",
    day: "day1",
    track: "special",
    start: "14:00",
    end: "16:30",
    activityKey: "power-workshop",
    shortTitle: { zh: "电力专题研讨会", en: "Power Workshop" },
    status: "pending",
  },
  {
    id: "d2-main-am",
  ...
  },
  {
    ...
    shortTitle: { zh: "石油化工分论坛", en: "Petrochemical Sub-forum" },
    status: "updating",
  },
  {
    ...
    activityKey: "battery",
    shortTitle: { zh: "电池分论坛", en: "Battery Sub-forum" },
    status: "updating",
  },
  {
    ...
    shortTitle: { zh: "电子电器分论坛", en: "Electronics Sub-forum" },
    status: "updating",
  },
  {
    ...
    shortTitle: { zh: "LCA 与碳足迹数据议题（英文）", en: "LCA & Carbon Data (EN)" },
    status: "published",
  },
];
...
export const activityAgendaDetails: ActivityAgendaDetail[] = [
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        day: "day2",
        title: { zh: "Llorenç Milà i Canals", en: "Llorenc Mila i Canals" },
        sessionType: { zh: "主旨报告", en: "Keynote" },
        speakers: {
      ...
      },
      {
        id: "mf-d2-keynote-xu",
        day: "day2",
        title: { zh: "徐明", en: "Xu Ming" },
        sessionType: { zh: "主旨报告", en: "Keynote" },
        speakers: { zh: "清华大学讲席教授" },
      },
      {
        ...
        sessionType: { zh: "主旨报告", en: "Keynote" },
        speakers: { zh: "柏林工业大学教授", en: "Professor, TU Berlin" },
      },
      {
  ...
  },
  {
    activityKey: "petrochemical",
    groupKey: "sub-forums",
    title: { zh: "石油化工分论坛", en: "Petrochemical Sub-forum" },
    summaryLead: {
      zh: "主持人：\n韦志浩，中国化工节能技术协会党委书记\n李永亮，中国化工节能技术协会秘书长、中国石油和化学工业联合会科技与装备部主任",
      en: "Moderators:\nWei Zhihao, Party Secretary, China Chemical Energy Conservation Technology Association\nLi Yongliang, Secretary-General, China Chemical Energy Conservation Technology Association; Director, Department of Science & Technology and Equipment, China Petroleum and Chemical Industry Federation",
    },
    summary: {
  ...
  },
  {
    activityKey: "battery",
    groupKey: "sub-forums",
    title: { zh: "电池分论坛", en: "Battery Sub-forum" },
    summary: {
  ...
  },
  {
    activityKey: "electronics",
    groupKey: "sub-forums",
    title: { zh: "电子电器分论坛", en: "Electronics Sub-forum" },
    summaryLead: {
      zh: "主持人：\n田金平，清华大学环境学院研究员",
  ...
  },
  {
    activityKey: "lca-audit",
    groupKey: "sub-forums",
    title: { zh: "LCA 与碳足迹数据议题（英文）", en: "LCA & Carbon Data Forum (EN)" },
    summaryLead: {
      zh: "主持人：\nAlessandro Manzardo，帕多瓦大学土木、建筑与环境工程系（ICEA）环境质量研究中心（CESQA）副教授",
      en: "Moderator:\nAlessandro Manzardo, Associate Professor, CESQA | Centro Studi Qualità Ambiente\nDipartimento Ingegneria Civile Edile Ambientale (ICEA), Università degli Studi di Padova",
    },
    summary: {
  ...
  },
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        note: {
          zh: "Départ de Sentier 主席（Brightway）",
      ...
      },
      {
        ...
        note: { zh: "GreenDelta CEO（openLCA）", en: "CEO, GreenDelta" },
      },
      {
        id: "dev-hiq",
        day: "day1",
        ...
        note: { zh: "海科数据 CEO（HiQ LCD）", en: "CEO, HiQLCD" },
      },
      {
        id: "dev-minviro",
        day: "day1",
      ...
      },
      {
        ...
        note: {
          zh: "One Click LCA 首席创新官；PRé 总经理（SimaPro）",
  ...
  },
  {
    ...
    title: { zh: "联盟全体会员大会", en: "Alliance General Assembly" },
    summaryLead: {
      zh: "主持人：\n徐明，碳足迹产业技术创新联盟秘书长",
    ...
    summary: {
      ...
      en: "The Alliance General Assembly will focus on the alliance’s annual priority work, including updates on phased progress, review of the annual work plan and related matters, collection of feedback and suggestions from member organizations, and coordination on next-step cooperation directions and priority tasks, in order to advance the alliance’s work in an orderly manner.",
    },
  ...
  },
  {
    ...
    summary: {
      ...
      en: "This focused workshop will conduct technical discussions and exchanges around the Ministry of Ecology and Environment’s Guidelines for the Construction of Product Carbon Footprint Factor Databases, targeting research institutions, technical service providers, industry associations, and enterprises involved in national and local factor database development. The workshop will focus on key topics for building high-quality factor databases, including methodologies and accounting boundaries, data structures and metadata, data resources and quality management, and supporting tools and platforms. Through thematic presentations, case sharing, and technical exchange, it aims to advance the development of a product carbon footprint data system that is broad in coverage, high in quality, sustainably updatable, and internationally influential.",
    },
    dateLabel: { zh: "2026 年 3 月 25 日", en: "March 25, 2026" },
  ...
  },
  {
    activityKey: "power-workshop",
    groupKey: "special-events",
    title: { zh: "电力专题研讨会", en: "Power Sector Workshop" },
    summaryLead: {
